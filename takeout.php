...
<head>
<meta charset="utf-8">
<title>お弁当 | 喜重会館 宴会・婚礼・仕出し・祝膳・仏膳 | 宮崎県日向市</title>
...
<div class="block m-t-40">
    ...
    <div class="menu-txt">
        ...
        <div class="tile a1-b1-c3 am40-bm40-cm30 m-t-20">
            <?php foreach($takeout as $i):?>
            <div class="menu-warp">
                <div class="thumb"><img src="./images/<?= $i['img']?>"></div>
                <strong><?= $i['name']?></strong>
                <?php if(isset($i['no_tax'])):?>
            ...
            <?php endforeach?>
             ...
             <!--
            <div class="menu-warp">
                <div class="thumb"><img src="./images/takeout/11_750.jpg"></div>
                <strong>うな丼</strong>
                
                <div class="price">1,080円<span>(税込み)</span></div>
            </div>
          
            <div class="menu-warp">
                <div class="thumb"><img src="./images/takeout/14_500.jpg"></div>
                <strong>ロースカツ丼</strong>
                
                <div class="price">500円<span>(税込み)</span></div>
            </div>
           
            <div class="menu-warp">
                <div class="thumb"><img src="./images/takeout/15_500.jpg"></div>
                <strong>天ぷら丼</strong>
